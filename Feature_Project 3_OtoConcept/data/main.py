...
def generateEpoch(trainFile, sentences, howMany):
...
'''
cur_sent = 0
sentences = randomizeFile(TRAINING_SET)

while generateEpoch("TRAIN.txt", sentences, 10) == 0:
